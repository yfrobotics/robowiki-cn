...
![双目视差几何与深度分辨率](assets/stereo-disparity.svg)

右图给出了这一劣化的量级：在 f = 700 px、b = 60 mm、亚像素精度 0.25 px 的典型配置下，1 m 处的深度分辨率约 6 mm，5 m 处已劣化到约 150 mm，10 m 处接近 600 mm。这是双目方案的物理限制，无法靠更好的匹配算法弥补。
