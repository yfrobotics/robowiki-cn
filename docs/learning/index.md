...
- [具身智能](embodied-ai.md) — 与传统流水线的边界划分、三条技术路线、评价基准与尚未解决的问题
- [VLA 模型](embodied-ai-vla.md) — 动作表示的四种选择、主流模型对比、推理频率约束、微调实践
- [VLA 微调与评测](vla-training-evaluation.md) — 观测与动作契约、数据检查、动作块时序、闭环评测与故障排查
- [模仿学习与数据采集](embodied-ai-data.md) — 复合误差的理论与缓解、ACT 与扩散策略、遥操作方案、数据质量
